This directory contains Go command-line tools used to prepare image files for webpages and generate reusable HTML for a gallery of photos.

## Application

webgallery contains two small Go CLIs used to create a gallery of photos for the website of the developer's dog, Rosie the Dog. The plan is to also use it for a future website, Albuquerque Dog.
